...
<template>
  <div class="flex flex-col gap-4 post">
    <div class="p-10 bg-content shadow-lg post-block">
      <article class="post-content">
        <header class="flex flex-col items-center post-header">
          <h1 class="text-3xl/loose text-center w-fit post-title">
            {{ post?.title }}
          </h1>
